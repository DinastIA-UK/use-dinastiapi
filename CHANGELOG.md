...
Para detalhes completos, veja a [release v2.2.3](https://github.com/DinastIA-UK/use-dinastiapi/releases/tag/v2.2.3).

### 📦 Pacotes Disponíveis

- Linux AMD64: `linux-amd64-v2.2.3.tar.gz`
- Linux ARM64: `linux-arm64-v2.2.3.tar.gz`
- macOS Intel: `darwin-amd64-v2.2.3.tar.gz`
- macOS Apple Silicon: `darwin-arm64-v2.2.3.tar.gz`
- Windows: `windows-amd64-v2.2.3.zip`
...
Para detalhes completos, veja a [release v2.2.2](https://github.com/DinastIA-UK/use-dinastiapi/releases/tag/v2.2.2).

### 📦 Pacotes Disponíveis

- Linux AMD64: `linux-amd64-v2.2.2.tar.gz`
- Linux ARM64: `linux-arm64-v2.2.2.tar.gz`
- macOS Intel: `darwin-amd64-v2.2.2.tar.gz`
- macOS Apple Silicon: `darwin-arm64-v2.2.2.tar.gz`
- Windows: `windows-amd64-v2.2.2.zip`
...
Para detalhes completos, veja a [release v2.1.0](https://github.com/DinastIA-UK/use-dinastiapi/releases/tag/v2.1.0).

### 📦 Pacotes Disponíveis

- Linux AMD64: `linux-amd64-v2.1.0.tar.gz`
- Linux ARM64: `linux-arm64-v2.1.0.tar.gz`
- macOS Intel: `darwin-amd64-v2.1.0.tar.gz`
- macOS Apple Silicon: `darwin-arm64-v2.1.0.tar.gz`
- Windows: `windows-amd64-v2.1.0.zip`
...
Para detalhes completos, veja a [release v1.20.1](https://github.com/DinastIA-UK/use-dinastiapi/releases/tag/v1.20.1).

### 📦 Pacotes Disponíveis

- Linux AMD64: `linux-amd64-v1.20.1.tar.gz`
- Linux ARM64: `linux-arm64-v1.20.1.tar.gz`
- macOS Intel: `darwin-amd64-v1.20.1.tar.gz`
- macOS Apple Silicon: `darwin-arm64-v1.20.1.tar.gz`
- Windows: `windows-amd64-v1.20.1.zip`
...
Para detalhes completos, veja a [release v1.20.0](https://github.com/DinastIA-UK/use-dinastiapi/releases/tag/v1.20.0).

### 📦 Pacotes Disponíveis

- Linux AMD64: `linux-amd64-v1.20.0.tar.gz`
- Linux ARM64: `linux-arm64-v1.20.0.tar.gz`
- macOS Intel: `darwin-amd64-v1.20.0.tar.gz`
- macOS Apple Silicon: `darwin-arm64-v1.20.0.tar.gz`
- Windows: `windows-amd64-v1.20.0.zip`
...
Para detalhes completos, veja a [release v1.19.0](https://github.com/DinastIA-UK/use-dinastiapi/releases/tag/v1.19.0).

### 📦 Pacotes Disponíveis

- Linux AMD64: `linux-amd64-v1.19.0.tar.gz`
- Linux ARM64: `linux-arm64-v1.19.0.tar.gz`
- macOS Intel: `darwin-amd64-v1.19.0.tar.gz`
- macOS Apple Silicon: `darwin-arm64-v1.19.0.tar.gz`
- Windows: `windows-amd64-v1.19.0.zip`
...
Para detalhes completos, veja a [release v1.18.1](https://github.com/DinastIA-UK/use-dinastiapi/releases/tag/v1.18.1).

### 📦 Pacotes Disponíveis

- Linux AMD64: `linux-amd64-v1.18.1.tar.gz`
- Linux ARM64: `linux-arm64-v1.18.1.tar.gz`
- macOS Intel: `darwin-amd64-v1.18.1.tar.gz`
- macOS Apple Silicon: `darwin-arm64-v1.18.1.tar.gz`
- Windows: `windows-amd64-v1.18.1.zip`
...
Para detalhes completos, veja a [release v1.17.0](https://github.com/DinastIA-UK/use-dinastiapi/releases/tag/v1.17.0).

### 📦 Pacotes Disponíveis

- Linux AMD64: `linux-amd64-v1.17.0.tar.gz`
- Linux ARM64: `linux-arm64-v1.17.0.tar.gz`
- macOS Intel: `darwin-amd64-v1.17.0.tar.gz`
- macOS Apple Silicon: `darwin-arm64-v1.17.0.tar.gz`
- Windows: `windows-amd64-v1.17.0.zip`
...
Para detalhes completos, veja a [release v1.15.0](https://github.com/DinastIA-UK/use-dinastiapi/releases/tag/v1.15.0).

### 📦 Pacotes Disponíveis

- Linux AMD64: `linux-amd64-v1.15.0.tar.gz`
- Linux ARM64: `linux-arm64-v1.15.0.tar.gz`
- macOS Intel: `darwin-amd64-v1.15.0.tar.gz`
- macOS Apple Silicon: `darwin-arm64-v1.15.0.tar.gz`
- Windows: `windows-amd64-v1.15.0.zip`
...
Para detalhes completos, veja a [release v1.13.3](https://github.com/DinastIA-UK/use-dinastiapi/releases/tag/v1.13.3).

### 📦 Pacotes Disponíveis

- Linux AMD64: `linux-amd64-v1.13.3.tar.gz`
- Linux ARM64: `linux-arm64-v1.13.3.tar.gz`
- macOS Intel: `darwin-amd64-v1.13.3.tar.gz`
- macOS Apple Silicon: `darwin-arm64-v1.13.3.tar.gz`
- Windows: `windows-amd64-v1.13.3.zip`
...
Para detalhes completos, veja a [release v1.13.2](https://github.com/DinastIA-UK/use-dinastiapi/releases/tag/v1.13.2).

### 📦 Pacotes Disponíveis

- Linux AMD64: `linux-amd64-v1.13.2.tar.gz`
- Linux ARM64: `linux-arm64-v1.13.2.tar.gz`
- macOS Intel: `darwin-amd64-v1.13.2.tar.gz`
- macOS Apple Silicon: `darwin-arm64-v1.13.2.tar.gz`
- Windows: `windows-amd64-v1.13.2.zip`
...
Para detalhes completos, veja a [release v1.13.1](https://github.com/DinastIA-UK/use-dinastiapi/releases/tag/v1.13.1).

### 📦 Pacotes Disponíveis

- Linux AMD64: `linux-amd64-v1.13.1.tar.gz`
- Linux ARM64: `linux-arm64-v1.13.1.tar.gz`
- macOS Intel: `darwin-amd64-v1.13.1.tar.gz`
- macOS Apple Silicon: `darwin-arm64-v1.13.1.tar.gz`
- Windows: `windows-amd64-v1.13.1.zip`
...
Para detalhes completos, veja a [release v1.10.0](https://github.com/DinastIA-UK/use-dinastiapi/releases/tag/v1.10.0).

### 📦 Pacotes Disponíveis

- Linux AMD64: `linux-amd64-v1.10.0.tar.gz`
- Linux ARM64: `linux-arm64-v1.10.0.tar.gz`
- macOS Intel: `darwin-amd64-v1.10.0.tar.gz`
- macOS Apple Silicon: `darwin-arm64-v1.10.0.tar.gz`
- Windows: `windows-amd64-v1.10.0.zip`
...
Para detalhes completos, veja a [release v1.9.1](https://github.com/DinastIA-UK/use-dinastiapi/releases/tag/v1.9.1).

### 📦 Pacotes Disponíveis

- Linux AMD64: `linux-amd64-v1.9.1.tar.gz`
- Linux ARM64: `linux-arm64-v1.9.1.tar.gz`
- macOS Intel: `darwin-amd64-v1.9.1.tar.gz`
- macOS Apple Silicon: `darwin-arm64-v1.9.1.tar.gz`
- Windows: `windows-amd64-v1.9.1.zip`
...
Para detalhes completos, veja a [release v1.9.0](https://github.com/DinastIA-UK/use-dinastiapi/releases/tag/v1.9.0).

### 📦 Pacotes Disponíveis

- Linux AMD64: `linux-amd64-v1.9.0.tar.gz`
- Linux ARM64: `linux-arm64-v1.9.0.tar.gz`
- macOS Intel: `darwin-amd64-v1.9.0.tar.gz`
- macOS Apple Silicon: `darwin-arm64-v1.9.0.tar.gz`
- Windows: `windows-amd64-v1.9.0.zip`
...
Para detalhes completos, veja a [release v1.7.0](https://github.com/DinastIA-UK/use-dinastiapi/releases/tag/v1.7.0).

### 📦 Pacotes Disponíveis

- Linux AMD64: `linux-amd64-v1.7.0.tar.gz`
- Linux ARM64: `linux-arm64-v1.7.0.tar.gz`
- macOS Intel: `darwin-amd64-v1.7.0.tar.gz`
- macOS Apple Silicon: `darwin-arm64-v1.7.0.tar.gz`
- Windows: `windows-amd64-v1.7.0.zip`
...
Para detalhes completos, veja a [release v1.6.1](https://github.com/DinastIA-UK/use-dinastiapi/releases/tag/v1.6.1).

### 📦 Pacotes Disponíveis

- Linux AMD64: `linux-amd64-v1.6.1.tar.gz`
- Linux ARM64: `linux-arm64-v1.6.1.tar.gz`
- macOS Intel: `darwin-amd64-v1.6.1.tar.gz`
- macOS Apple Silicon: `darwin-arm64-v1.6.1.tar.gz`
- Windows: `windows-amd64-v1.6.1.zip`
...
Para detalhes completos, veja a [release v1.5.4](https://github.com/DinastIA-UK/use-dinastiapi/releases/tag/v1.5.4).

### 📦 Pacotes Disponíveis

- Linux AMD64: `linux-amd64-v1.5.4.tar.gz`
- Linux ARM64: `linux-arm64-v1.5.4.tar.gz`
- macOS Intel: `darwin-amd64-v1.5.4.tar.gz`
- macOS Apple Silicon: `darwin-arm64-v1.5.4.tar.gz`
- Windows: `windows-amd64-v1.5.4.zip`
...
Para detalhes completos, veja a [release v1.5.3](https://github.com/DinastIA-UK/use-dinastiapi/releases/tag/v1.5.3).

### 📦 Pacotes Disponíveis

- Linux AMD64: `linux-amd64-v1.5.3.tar.gz`
- Linux ARM64: `linux-arm64-v1.5.3.tar.gz`
- macOS Intel: `darwin-amd64-v1.5.3.tar.gz`
- macOS Apple Silicon: `darwin-arm64-v1.5.3.tar.gz`
- Windows: `windows-amd64-v1.5.3.zip`
...
Para detalhes completos, veja a [release v1.5.2](https://github.com/DinastIA-UK/use-dinastiapi/releases/tag/v1.5.2).

### 📦 Pacotes Disponíveis

- Linux AMD64: `linux-amd64-v1.5.2.tar.gz`
- Linux ARM64: `linux-arm64-v1.5.2.tar.gz`
- macOS Intel: `darwin-amd64-v1.5.2.tar.gz`
- macOS Apple Silicon: `darwin-arm64-v1.5.2.tar.gz`
- Windows: `windows-amd64-v1.5.2.zip`
...
Para detalhes completos, veja a [release v1.5.1](https://github.com/DinastIA-UK/use-dinastiapi/releases/tag/v1.5.1).

### 📦 Pacotes Disponíveis

- Linux AMD64: `linux-amd64-v1.5.1.tar.gz`
- Linux ARM64: `linux-arm64-v1.5.1.tar.gz`
- macOS Intel: `darwin-amd64-v1.5.1.tar.gz`
- macOS Apple Silicon: `darwin-arm64-v1.5.1.tar.gz`
- Windows: `windows-amd64-v1.5.1.zip`
...
Para detalhes completos, veja a [release v1.5.0](https://github.com/DinastIA-UK/use-dinastiapi/releases/tag/v1.5.0).

### 📦 Pacotes Disponíveis

- Linux AMD64: `linux-amd64-v1.5.0.tar.gz`
- Linux ARM64: `linux-arm64-v1.5.0.tar.gz`
- macOS Intel: `darwin-amd64-v1.5.0.tar.gz`
- macOS Apple Silicon: `darwin-arm64-v1.5.0.tar.gz`
- Windows: `windows-amd64-v1.5.0.zip`
...
Para detalhes completos, veja a [release v1.4.8](https://github.com/DinastIA-UK/use-dinastiapi/releases/tag/v1.4.8).

### 📦 Pacotes Disponíveis

- Linux AMD64: `linux-amd64-v1.4.8.tar.gz`
- Linux ARM64: `linux-arm64-v1.4.8.tar.gz`
- macOS Intel: `darwin-amd64-v1.4.8.tar.gz`
- macOS Apple Silicon: `darwin-arm64-v1.4.8.tar.gz`
- Windows: `windows-amd64-v1.4.8.zip`
...
Para detalhes completos, veja a [release v1.4.7](https://github.com/DinastIA-UK/use-dinastiapi/releases/tag/v1.4.7).

### 📦 Pacotes Disponíveis

- Linux AMD64: `linux-amd64-v1.4.7.tar.gz`
- Linux ARM64: `linux-arm64-v1.4.7.tar.gz`
- macOS Intel: `darwin-amd64-v1.4.7.tar.gz`
- macOS Apple Silicon: `darwin-arm64-v1.4.7.tar.gz`
- Windows: `windows-amd64-v1.4.7.zip`
...
Para detalhes completos, veja a [release v1.4.6](https://github.com/DinastIA-UK/use-dinastiapi/releases/tag/v1.4.6).

### 📦 Pacotes Disponíveis

- Linux AMD64: `linux-amd64-v1.4.6.tar.gz`
- Linux ARM64: `linux-arm64-v1.4.6.tar.gz`
- macOS Intel: `darwin-amd64-v1.4.6.tar.gz`
- macOS Apple Silicon: `darwin-arm64-v1.4.6.tar.gz`
- Windows: `windows-amd64-v1.4.6.zip`
...
Para detalhes completos, veja a [release v1.4.5](https://github.com/DinastIA-UK/use-dinastiapi/releases/tag/v1.4.5).

### 📦 Pacotes Disponíveis

- Linux AMD64: `linux-amd64-v1.4.5.tar.gz`
- Linux ARM64: `linux-arm64-v1.4.5.tar.gz`
- macOS Intel: `darwin-amd64-v1.4.5.tar.gz`
- macOS Apple Silicon: `darwin-arm64-v1.4.5.tar.gz`
- Windows: `windows-amd64-v1.4.5.zip`
...
<html>
<head>
  <title>Monitoramento dinastiapi</title>
</head>
<body>
  <div id="status"></div>
  <div id="events"></div>
...
1. **Atualizar imagem Docker:**
   ```bash
   docker pull dinastiapi/dinastiapi-private:v1.2.6
   # ou
   docker pull dinastiapi/dinastiapi-private:latest
   ```
...
- 🐛 **Issues**: [GitHub Issues](https://github.com/DinastIA-UK/use-dinastiapi/issues)
- 📚 **Documentação**: [README](https://github.com/DinastIA-UK/use-dinastiapi/blob/main/README.md)
