...
services:
  dinastiapi_private:
    ...
    environment:
      ...
      # DINASTIAPI_ADDRESS: Define o endereço base para a API DinastiAPI
      ...
      - DINASTIAPI_ADDRESS=https://api.dinastiapi.app
      ...
      - DATABASE_URL=postgres://dinastiapi:dinastiapi@postgres_dinastiapi:5432/dinastiapi?sslmode=disable&search_path=public
      # For managed databases: DATABASE_URL=postgres://user:pass@managed-db.example.com:5432/dinastiapi?sslmode=require
      # For MySQL: DATABASE_URL=mysql://dinastiapi:dinastiapi_production_password@dinastiapi_mysql:3306/dinastiapi?charset=utf8mb4&parseTime=True&loc=Local
      ...
      - GLOBAL_WEBHOOK_URL=https://hook.prod.dinastiapi.com/webhook/global-events
      ...
      - GLOBAL_RABBITMQ_URL=amqp://dinastiapi:dinastiapi@rabbitmq_dinastiapi:5672/dinastiapi
